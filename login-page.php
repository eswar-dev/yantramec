  ...
  <div class="container">
    ...
    <div id="login-form">
        <form>
            ...
            <button type="button" class="btn -box-sd-effect"> <i class="fa fa-linkedin fa-lg" aria-hidden="true"></i> <span class="text">  sign in with linkedin</span></button>
            <button type="button" class="btn -box-sd-effect"> <i class="fa fa-windows fa-lg" aria-hidden="true"></i> <span class="text">sign in with microsoft</span> </button>
        </form>
    </div>
</div>
  </div><br>
