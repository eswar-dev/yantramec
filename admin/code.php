...
include 'security.php';
  ...
  if(isset($_POST['delete_event']))
  {
    ...
    if(isset($_POST['add_transaction']))
    {
        ...
        $payment_id = "pay_".substr($token1, 0, 14);
            ...
            $query = "INSERT INTO transactions (order_id,payment_id,user_id,event_id,amount,status,txn_time) VALUES ('$order_id','$payment_id','$user_id','$event','$amount','$status','$txn_time')";
            $query_run = mysqli_query($connection,$query);
  ...
  if(isset($_POST['update_transaction']))
  {
    ...
    $query = "UPDATE transactions SET user_id = '$user_id',event_id = '$event',amount ='$amount'' WHERE order_id = '$id'";
    $query_run = mysqli_query($connection,$query);
